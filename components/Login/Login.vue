<template>
  <div class="container my-4" style="background-color: #181D31; width: 70%; border-radius: 10px ;">
    <div class="row border">
      <div class="col-7">
        <a href="./register.html" style="color: red; font-size: 30px;">
